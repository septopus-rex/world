 ...
 */
export function StatusPanel({ loader, version }: { loader: any; version: string }) {
    ...
    return (
        <div className="absolute top-3 left-3 z-20 pointer-events-auto select-none">
            ...
            {open && (
                <div data-testid="status-body" className="mt-1.5 w-32 px-3 py-2 rounded-xl bg-black/55 border border-white/10 backdrop-blur text-[11px] font-mono space-y-1">
