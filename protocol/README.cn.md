...
| [**boot-chain 全链启动**](cn/boot-chain.md) | **比特币锚 → ROOT loader → 世界:锚微格式/密钥权威/boot shim 契约(规范,2026-07-08)** |
| [**envelope 封套与内容寻址**](cn/envelope.md) | **统一文档封套 · CID(真 CIDv1)· 版本三分纪律(规范,2026-07-08)** |
