...
const septopus = {
    ...
    "2023_620": [0.2, 1, [      //AI
        [0x00a2,
            [   
                //7 AI
                [[0.6, 0.6, 4], [ 15, 7.5, 3], [0, 0, 0], 202, [1, 1], [2, 0.02], 1],
                [[0.6, 0.6, 4], [ 12.18, 13.36, 3], [0, 0, 0], 202, [1, 1], [2, 0.02], 1],
                [[0.6, 0.6, 4], [ 5.83, 14.81, 3], [0, 0, 0], 202, [1, 1], [2, 0.02], 1],
                [[0.6, 0.6, 4], [ 0.74, 10.76, 3], [0, 0, 0], 202, [1, 1], [2, 0.02], 1],
                [[0.6, 0.6, 4], [ 0.74, 4.24, 3], [0, 0, 0], 202, [1, 1], [2, 0.02], 1],
                [[0.6, 0.6, 4], [ 5.83, 0.19, 3], [0, 0, 0], 202, [1, 1], [2, 0.02], 1],
                [[0.6, 0.6, 4], [ 12.18, 1.64, 3], [0, 0, 0], 202, [1, 1], [2, 0.02], 1],
                ...
                [[8, 8, 2.25], [ 8, 8, 1.125], [0, 0, 0], 203, [1, 1], 0, 1],
            ]
        ]
    ]],
    "2023_618": [0.2, 1, [      //King
