...
const septopus = {
    ...
    "2023_620": [0.2, 1, [      //AI
        [0x00a2,
            [
                [[0.6, 0.6, 4], [ 8, 2, 3], [0, 0, 0], 202, [1, 1], 0, 1],
                [[0.6, 0.6, 4], [ 10, 5, 3], [0, 0, 0], 202, [1, 1], 0, 1],
                [[0.6, 0.6, 4], [ 6, 5, 3], [0, 0, 0], 202, [1, 1], 0, 1],
                [[0.6, 0.6, 4], [ 4, 8, 3], [0, 0, 0], 202, [1, 1], 0, 1],
                [[0.6, 0.6, 4], [ 12, 8, 3], [0, 0, 0], 202, [1, 1], 0, 1],
                [[0.6, 0.6, 4], [ 5, 12, 3], [0, 0, 0], 202, [1, 1], 0, 1],
                [[0.6, 0.6, 4], [ 11, 12, 3], [0, 0, 0], 202, [1, 1], 0, 1],
            ]
        ]
    ]],
    "2023_618": [0.2, 1, [      //King
