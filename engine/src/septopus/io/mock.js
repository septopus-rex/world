            ...
            return {
                ...
                data: [
                    ...
                    [
                        ...
                        [0x00a2,    //box
                            [
                                [[4,4,0.2],[14,14,0.1], [0, 0, 0], rand(60, 90), [1, 1], 1,1]
                            ]
                        ],
                    ],
                    1,  //block status
            ...
            return {
                ...
                data: [
                    ...
                    [
                       [0x00a2,    //wall
                            [
                                [[6,4,0.25], [12, 14, 0.125], [0, 0, 0], rand(60, 90), [1, 1], 1, 1],    //single
                            ]], 
                    ],  
                    1,  //block status
                ],
            ...
            return {
                ...
                data: [
                    ...
                    [
                        ...
                        [0x00a2,    //box
                            [
                                [[1,1,3],[15,14,6], [0, 0, 0], rand(60, 90), [1, 1], 1,1],
                                [[1,1,3],[15,13,6.25], [0, 0, 0], rand(60, 90), [1, 1], 1,1],
                                [[1,1,3],[15,12,6.5], [0, 0, 0], rand(60, 90), [1, 1], 1,1],
                                [[1,1,3],[15,11,6.75], [0, 0, 0], rand(60, 90), [1, 1], 1,1],
                                [[1,1,3],[15,10,7], [0, 0, 0], rand(60, 90), [1, 1], 1,1],
                                [[1,1,3],[15,9,7.25], [0, 0, 0], rand(60, 90), [1, 1], 1,1],
                                [[1,1,3],[15,8,7.5], [0, 0, 0], rand(60, 90), [1, 1], 1,1],
                                [[1,1,3],[15,7,7.75], [0, 0, 0], rand(60, 90), [1, 1], 1,1],
                                [[1,1,3],[15,6,8], [0, 0, 0], rand(60, 90), [1, 1], 1,1],
                                [[1,1,3],[15,5,8.25], [0, 0, 0], rand(60, 90), [1, 1], 1,1],
                                [[1,1,3],[15,4,8.5], [0, 0, 0], rand(60, 90), [1, 1], 1,1],
                                [[1,1,3],[15,3,8.75], [0, 0, 0], rand(60, 90), [1, 1], 1,1],
                                [[1,1,3],[15,2,9], [0, 0, 0], rand(60, 90), [1, 1], 1,1],
                                [[1,1,3],[15,1,9.25], [0, 0, 0], rand(60, 90), [1, 1], 1,1],
                                [[1,1,3],[14,1,9.5], [0, 0, 0], rand(60, 90), [1, 1], 1,1],
                                [[1,1,3],[13,1,9.75], [0, 0, 0], rand(60, 90), [1, 1], 1,1],
                                [[1,1,3],[12,1,10], [0, 0, 0], rand(60, 90), [1, 1], 1,1],
                                [[1,1,3],[11,1,10.25], [0, 0, 0], rand(60, 90), [1, 1], 1,1],
                                [[1,1,3],[10,1,10.5], [0, 0, 0], rand(60, 90), [1, 1], 1,1],
                                [[1,1,3],[9,1,10.75], [0, 0, 0], rand(60, 90), [1, 1], 1,1],
                                [[1,1,3],[8,1,11], [0, 0, 0], rand(60, 90), [1, 1], 1,1],
                                [[1,1,3],[7,1,11.25], [0, 0, 0], rand(60, 90), [1, 1], 1,1],
                                [[1,1,3],[6,1,11.5], [0, 0, 0], rand(60, 90), [1, 1], 1,1],
                                [[1,1,3],[5,1,11.75], [0, 0, 0], rand(60, 90), [1, 1], 1,1],
                                [[1,1,3],[4,1,12], [0, 0, 0], rand(60, 90), [1, 1], 1,1],
                                [[1,1,3],[3,1,12.25], [0, 0, 0], rand(60, 90), [1, 1], 1,1],
                                [[1,1,3],[2,1,12.5], [0, 0, 0], rand(60, 90), [1, 1], 1,1],
                                ...
                                [[3,3,3],[8,8,6], [0, 0, 0], rand(60, 90), [1, 1], 0,1], //ad
                                [[3,3,3],[8,8,12], [0, 0, 0], rand(60, 90), [1, 1], 1,1], //ad
                            ]],
                    ],
                    1,  //block status
                ],
                    ...
                    [
                        [0x00a2,    //wall
                            [
                                ...
                                [[4, 4, 1.7], [2.5, 2, 0.85], [0, 0, 0], rand(60, 90), [1, 1], 1, 1],    //7 single

                                [[1, 4, 1.4], [14, 2, 0.85], [0, 0, 0], rand(60, 90), [1, 1], 1, 1],    //8 single
                                [[1, 4, 2.2], [12, 2, 1.1], [0, 0, 0], rand(60, 90), [1, 1], 1, 1],    //8 single

                                [[4, 2, 3], [9, 1, 1.5], [0, 0, 0], rand(60, 90), [1, 1], 1, 1],       //9 single
                            ]],
                    ],
                    1,  //block status
                ],
