                    ...
                    [
                        [0x00a2,    //box
                            [
                                ...
                                [[1.2,1.2,6],[4,2,3], [0, 0, 0], 202, [1, 1], 0,1],
                                [[1.2,1.2,6],[12,2,3], [0, 0, 0], 202, [1, 1], 0,1],
                                [[1.2,1.2,6],[4,6,3], [0, 0, 0], 202, [1, 1], 0,1],
                                [[1.2,1.2,6],[12,6,3], [0, 0, 0], 202, [1, 1], 0,1],
                                [[1.2,1.2,6],[4,10,3], [0, 0, 0], 202, [1, 1], 0,1],
                                [[1.2,1.2,6],[12,10,3], [0, 0, 0], 202, [1, 1], 0,1],
                                [[1.2,1.2,6],[4,14,3], [0, 0, 0], 202, [1, 1], 0,1],
                                [[1.2,1.2,6],[12,14,3], [0, 0, 0], 202, [1, 1], 0,1],
                            ]
                        ]
                    ],
                    0,
    ...
    texture: (id) => {
        ...
        const map={
            ...
            201:{
                ...
                repeat: [1, 1],//"texture/brick_bump.jpg",
            },
            202:{
                index: id,
                type:"texture",
