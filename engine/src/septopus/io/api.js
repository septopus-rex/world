    ...
    block: (x, y, world) => {
        ...
        return {
            ...
            data: [
                0.2,        //block elevation
                [           //adjuncts list
                    [0x00a1, [[[1.5, 0.2, rand(2, 5)], [2, 6, 0], [0, 0, 0], rand(60, 90), [1, 1], 1, 1,[], 2025]]],
                    [0x00a2, [[[rand(1, 3), rand(1, 3), rand(1, 3)], [8, 8, 2], [0, 0, 0], rand(100, 300), [1, 1], 0, 2025]]],
                    [0x00a4, [[[rand(2, 4), rand(2, 4), rand(2, 4)], [8, 12, 0.5], [0, 0, 0], rand(1, 30), 0, 2025]]],
                    [0x00b4, [[[rand(2, 4), 0, 0], [3, 2, 0.5], [0, 0, 0], 2, 2025]]]
                ],
                1,          //block status
            ],
