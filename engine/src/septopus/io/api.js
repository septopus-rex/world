            ...
            return {
                ...
                data:[
                    ...
                    [
                       [0x00a1,    //wall
                        [
                            [[2, 0.8, 0.25],[2, 4, 1.5], [0, 0, 0], rand(60, 90), [1, 1], 1, 1,[], 2025],
                            [[2, 1.6, 0.25],[2, 4.4, 1.25], [0, 0, 0], rand(60, 90), [1, 1], 1, 1,[], 2025],
                            [[2, 2.4, 0.25],[2, 4.8, 1], [0, 0, 0], rand(60, 90), [1, 1], 1, 1,[], 2025],
                            [[2, 3.2, 0.25],[2, 5.2, 0.75], [0, 0, 0], rand(60, 90), [1, 1], 1, 1,[], 2025],
                            [[2, 4, 0.25],  [2, 5.6, 0.5], [0, 0, 0], rand(60, 90), [1, 1], 1, 1,[], 2025],
                            [[2, 4.8, 0.25],[2, 6, 0.25], [0, 0, 0], rand(60, 90), [1, 1], 1, 1,[], 2025],
                            [[2, 5.6, 0.25],[2, 6.4, 0], [0, 0, 0], rand(60, 90), [1, 1], 1, 1,[], 2025],
                        ]],
                    ],
                    1,  //block status
                ],
