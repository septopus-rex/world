...
const self = {
     ...
     * @paramx           number      //block X
     * @paramy           number      //block Y
     * @param   elevation   number      //block elevation
     * @paramsize        object      //{x:x,y:y,z:z}
     * @paramoffset      object      //{ox:ox,oy:oy,oz:oz}
     * @paramface        string      //['x','y','z','-x','-y','-z']
     * @param   side        number[]    //[sideX,sideY]       
     * @paramdensity     object      //{offsetX:1,offsetY:1,limitZ:10}
     * */
