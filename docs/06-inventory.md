...
- [框架核心](./02-framework.md) - 跨 Block 规则、TriggerSystem
- [弦粒子系统](./03-string-particle.md) - 物品刷新点（Trigger）
- [AI 集成](./04-ai-integration.md) - AI 可设计物品分布
- [时间维度](./05-time-dimension.md) - 区块哈希驱动随机属性和定时刷新
