...
> [!NOTE]
> 弦粒子的链上二进制格式（数据结构、编码规则、约束）已独立为 [弦粒子协议规范](./03-string-particle-protocol.md)。本文档聚焦于引擎侧的构型定义、展开算法、主题系统和构建流程。
...
- [架构概述](./00-overview.md) - 系统总体架构（弦粒子是开创性特性之一）
- [类型定义](./01-types.md) - 基础件类型（Box、Wall、Stop、Trigger）
- [框架核心](./02-framework.md) - Pipeline 数据转换管线
- [AI 集成](./04-ai-integration.md) - AI 驱动的 3D 游戏开发（弦粒子是AI降维的关键）
