...
- [框架核心](../systems/framework.md) - 核心模块详细说明
- [弦粒子系统](../features/spp.md) - 空间内容快速构建
- [弦粒子协议](../features/spp-protocol.md) - 链上二进制格式规范
- [AI 集成](../features/ai-integration.md) - AI 驱动的 3D 游戏开发
- [时间维度](../features/time-dimension.md) - 区块链时间驱动的世界演化
- [背包系统](../features/inventory.md) - 物品拾取、存储与随机生成
- [ECS 核心架构](./ecs.md) - 组件化设计与数据流驱动
- [数据流管线](./pipeline.md) - 数据解析转换阶段
- [统一坐标系统](./coordinate.md) - 三维坐标投影策略
- [系统效率与性能优化](./performance.md) - 内存治理和负载策略
- [SPP-Core 协议](../features/spp-core.md) - 弦粒子语义塌陷协议
