...
- [SPP-Core 语义协议](../features/spp-core.md) - Layer 1 全状态定义和三层架构总览
- [弦粒子系统](../features/spp.md) - Layer 3 引擎侧实现（展开算法、构型定义、主题系统）
- [类型定义](../api/types.md) - 基础 Adjunct 类型和 Audio 类型
- [框架核心](../systems/framework.md) - Pipeline 和二进制编解码阶段
- [AI 集成](../features/ai-integration.md) - AI 生成弦粒子 JSON 的工作流
